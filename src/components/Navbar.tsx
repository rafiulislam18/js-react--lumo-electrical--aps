      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" className="w-56 rounded-xl shadow-xl border-gray-100 p-2" onOpenAutoFocus={(e) => e.preventDefault()}>
      ...
      <div className="hidden md:block border-t border-gray-100 bg-white/50">
        <div className="container mx-auto h-12 flex items-center gap-8">
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="start" className="w-56 rounded-xl p-2 shadow-lg border-gray-100" onOpenAutoFocus={(e) => e.preventDefault()}>
              {categories.map((cat) => (
